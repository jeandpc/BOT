		...
		if (!isUser) return reply(mess.only.daftarB)
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'termux':
					...
					buffer = await getBuffer(`https://i.ibb.co/Pg7vMYx/ab1fb2dc-a000-4e3b-a141-d65bfce7a744-2.jpg`)
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'expediente patrick'})
					buffer = await getBuffer(`https://i.ibb.co/VQ8H0fh/420a5008-d50b-40bb-96c1-a24da85ca528.jpg`)
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Terrible lo que paso en esa carta'})
					buffer = await getBuffer(`https://i.ibb.co/jTfCVFN/6dc7909f-e371-44b6-914f-6db73750efe2.jpg`)
					...
					buffer = await getBuffer(`https://i.ibb.co/HNRK9jC/Whats-App-Image-2021-08-03-at-17-13-43-2.jpg`)
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'le hago un trio '})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'cachable'})
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'ohhhhh me vengooooooooooooo'})
					break
